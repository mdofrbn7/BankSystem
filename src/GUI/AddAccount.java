...
public class AddAccount extends JFrame implements GlobalVers{
	...
	public AddAccount() {
		...
		btnAddCurrentAccount.setBackground(buttonColor);
		...
		btnAddStudentAccount.setBackground(buttonColor);
